...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/TrJHlgs.png Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~7bc91ae76c919950074e6709fd56692d:456d364175764f2f33574d3d').trim() || '',
    ...
    ALLOWED: process.env.ALLOWED || '91,94,2,1',
    NOT_ALLOWED: process.env.ALLOWED || '',
